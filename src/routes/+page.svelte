<script lang="ts">
	...
	function onMouseMove(e: MouseEvent): void {
      ...
      dragWindow.style.top = clickedAtWindowPosY + (e.pageY - clickedAtY) + 'px' */
		...
		secretImage.style.left =
			clickedAtSecretImagePosX + (e.pageX - clickedAtX) * backgroundParallaxRatio + 'px';
		secretImage.style.top =
			clickedAtSecretImagePosY + (e.pageY - clickedAtY) * backgroundParallaxRatio + 'px';
	}
	...
	function moveWindow(currentTime: number): void {
		...
		if (movingTo.right && !movingTo.left) {
			...
			background.style.backgroundPositionX =
				backgroundPosXInitial - backgroundParallaxRatio * elapsed + 'px';
		} else {
			startTime.xRight = null;
		}
		...
		if (movingTo.top && !movingTo.bottom) {
			...
			background.style.backgroundPositionY =
				backgroundPosYInitial + backgroundParallaxRatio * elapsed + 'px';
		} else {
			startTime.yUp = null;
		}
