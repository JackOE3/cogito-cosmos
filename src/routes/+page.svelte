<script lang="ts">
    ...
    import { LORCA_OVERRIDE, WindowId, unlocked } from '$lib/store'
    ...
    const backgroundParallaxRatio = 1 / 16
    const movingTo = {
        right: false,
        left: false,
        top: false,
...
<svelte:window onkeydown={onKeyDown} onkeyup={onKeyUp} onmousedown={onMouseDown} onmouseup={onMouseUp} onmousemove={onMouseMove} />
