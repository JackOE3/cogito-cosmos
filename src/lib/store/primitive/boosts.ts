...
const milkBoosts: Record<MilkBoost, Boost> = {
    [MilkBoost.ThoughtAccelBoostsItself]: {
        ...
        description: 'The effect of Thought Acceleration is multiplied by a factor proportional to the ' + 'amount of Thought Acceleration upgrades you own.',
        cost: 5,
        activated: false,
        available: false
    },
    [MilkBoost.ImproveFormulaCheeseBoostsThoughts]: {
        ...
        description: 'Improve the formula for cheese increasing thoughts/s <br> Current Formula: log(cheese + 1) <br>' + 'Improved Formula: sqrt(cheese)',
        cost: 10,
        activated: false,
        available: false
    },
    ...
    [MilkBoost.BetterScalingTotalCheeseMonsterDeathsLootBoost]: {
        label: 'Death Scaling',
        description: 'Better scaling for Upgrade “Total cheese monster deaths boost loot gain” <br>' + 'Scaling: quadratic -> cubic(?)',
        cost: 25,
        activated: false,
        available: false
    },
    [MilkBoost.UnspentCheeseBrainsBoostMonsterResourceGeneration]: {
        label: 'Brain Scaling',
        description: 'The cheese monster resource generation is boosted based on unspent cheese brains <br>' + 'Factor: cheeseBrains^1.5',
        cost: 25,
        activated: false,
        available: false
    },
...
export const skillTree: Boost[][] = [
    [milkBoosts.thoughtAccelBoostsItself, milkBoosts.improveFormulaCheeseQueueLengthBoostsCheese, milkBoosts.milkGainMultiplied],
    ...
    [milkBoosts.cheeseCyclesPerCheeseModeBoostCheese, milkBoosts.thoughtGainBoostedByThoughts, milkBoosts.collectiveSentienceBoosted],
    [
...
export const allowedSkillTreeConnections = ['000', '010', '011', '021', '100', '101', '112', '113', '210', '211', '221', '222', '300', '311', '322']
