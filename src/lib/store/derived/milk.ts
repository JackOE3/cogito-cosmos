    ...
    milkCheeseGain: [
        {
            name: UnlockName.STACKS_INCREASE_THOUGHT_BOOST_STRENGTH,
            upgradesNeeded: 3,
            description: 'While the Cheese Factory is running, gain an additional Thought Boost stack for every 10(?) overclocking levels',
            tooltipText: '-'
        },
        {
            name: UnlockName.STACKS_INCREASE_THOUGHT_BOOST_STRENGTH,
    ...
    milkCheeseBrainsGain: [
        {
            name: UnlockName.STACKS_INCREASE_THOUGHT_BOOST_STRENGTH,
            upgradesNeeded: 3,
            description: 'Smaller monster populations passively increase the collective sentience exponent depending on their size.',
            tooltipText: '-'
        },
        {
            name: UnlockName.STACKS_INCREASE_THOUGHT_BOOST_STRENGTH,
